...
```sh
python install.py install --project "/caminho/do/projeto" --mode orchestration --dry-run
python install.py install --project "/caminho/do/projeto" --mode orchestration
```
